...
- Every page uses a centered `width: 100%` wrapper. Workspace, Project, Lab Cabinet, AI & Models, Robotics, Tools, Documentation and UI Kit use the 1600 px wide wrapper; Settings uses the 1320 px compact wrapper. Documentation controls prose with an inner 72-character measure rather than a narrower page shell. Inner components never add competing page caps.
