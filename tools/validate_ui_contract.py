...
if '.message-totem {' not in ui_css or '.message-totem-actions' not in ui_css:errors.append('canonical Message Totem base/actions are not owned by shared UI CSS')
...
if 'Message Totem · confirmation' not in kit or 'Message Totem · status' not in kit:errors.append('UI Kit missing canonical Message Totem examples')
