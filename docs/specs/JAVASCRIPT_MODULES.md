...
- `ai/providers.js` / `ai/transport.js` / `ai/settings.js` — provider capabilities, direct-browser transport and settings; both local/LAN and hosted providers use the endpoint configured by the user.
