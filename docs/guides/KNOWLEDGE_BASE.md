...
The bundled KB contains **97 scientific/reference entries** in the current 0.0.30 source set; the generated browser bundle also includes the selected LabFlow documentation guides.
