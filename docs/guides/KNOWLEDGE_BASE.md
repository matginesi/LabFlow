...
The bundled KB contains **97 scientific/reference entries** in the current 0.0.28 source set; the generated browser bundle also includes the eight selected LabFlow documentation guides, for **105 active bundled entries** in total.
