...
module.exports=function(t){
  ...
  t['07 thinking never creates a second bubble']=function(){assert(js.includes('class="chat-thinking"'),false,'legacy thinking bubble removed');assert(js.includes("if(reasoning)run.message.reasoning=reasoning"),true,'reasoning stays on same message');};
