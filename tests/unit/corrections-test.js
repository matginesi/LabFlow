...
module.exports=function(t,LF){
  t['AI correction can target a deterministic finding id']=function(){
    const finding={id:'f1',target:'OLD',measurementId:'m1',status:'open'};
    const exp={sync:{revision:0},interpretationOverrides:{fields:{},units:{},scales:{}},patches:[],samples:[{id:'s1',name:'OLD',rawName:'old',aliases:['old'],group:'TEST',isRef:false}],measurements:[{id:'m1',sample:'OLD',rawSample:'old',path:'a.txt',group:'TEST',isRef:false}],findings:[finding],datasetAnalysis:{sourceRevision:0,ambiguousFindings:[finding]}};
  ...
  t['excluded danger diagnostics no longer keep dataset workflow blocked']=function(){
    ...
    LF.CanonicalStore={ensure:function(exp){return{experiment:{name:'x',sourceName:'x.zip'},evidence:[]};},summary:function(){return{files:1,samples:1,measurements:1,evidence:0,relations:0,aliases:0};},compact:function(value){return value;}};
