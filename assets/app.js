document.addEventListener('DOMContentLoaded', () => {
  ...
  const navigation = [
    ...
    { id: 'knowledge', href: 'knowledge.html',           icon: 'model',   label: 'Knowledge Chat' },
    { id: 'ai',        href: 'ai-assistant.html',        icon: 'spark',   label: 'AI workspace' },
  ...
  const cabinetResources=[
    ...
    {id:'pbi2',name:'Lead iodide',type:'Substance · precursor',category:'materials',status:'Available',tone:'success',availability:'available',location:'Dry cabinet A1',locationKey:'cabinet-a2',uses:11,favorite:false,icon:'PbI₂',description:'Perovskite precursor with reviewed identity and lot provenance.',meta:'CAS 10101-63-0 · TCI · lot PBI2-1187',details:[['Formula','PbI₂'],['Purity','99.99%'],['Storage','Dry · dark'],['Role','Precursor']],usage:'PSC-2026-041 · S01–S04 · SOL-081 and SOL-082'},
    {id:'sno2',name:'SnO₂ dispersion',type:'Material · ETL',category:'materials',status:'Low',tone:'warning',availability:'warning',location:'Materials fridge',locationKey:'lab-2',uses:9,favorite:true,icon:'SnO₂',description:'Electron transport material for n-i-p stack fabrication.',meta:'Alfa Aesar · lot SNO2-026',details:[['Role','ETL'],['Form','Colloidal dispersion'],['Storage','4 °C'],['Availability','Almost empty']],usage:'PSC-2026-041 · S01–S04 · ETL layer'},
    ...
    {id:'ito25',name:'Glass / ITO · 25 × 25 mm',type:'Substrate',category:'substrates',status:'Available',tone:'success',availability:'available',location:'Drawer B1',locationKey:'substrates-b1',uses:17,favorite:true,icon:'ITO',description:'Standard rigid substrate for n-i-p devices.',meta:'1.1 mm · 15 Ω/sq · 36 pieces',details:[['Dimensions','25 × 25 mm'],['Thickness','1.1 mm'],['Sheet resistance','15 Ω/sq'],['Quantity','36']],usage:'PSC-2026-041 · S01–S04 · substrate'},
    {id:'spin01',name:'Spin Coater 01',type:'Instrument · spin coater',category:'equipment',status:'Available',tone:'success',availability:'available',location:'Lab 2',locationKey:'lab-2',uses:26,recent:true,favorite:true,icon:'SC',description:'Primary spin coater for solution-processed thin films.',meta:'Laurell WS-650 · configurations: standard, two-step, antisolvent',details:[['Model','Laurell WS-650'],['Status','Available'],['Capabilities','Spin coating · dripping'],['Default','4000 rpm · 30 s']],usage:'PSC-2026-041 · spin coating S01–S04'},
    ...
    {id:'stackNip',name:'PSC n-i-p standard',type:'Stack template',category:'stacks',status:'Active',tone:'success',availability:'available',location:'Shared template',locationKey:'all',uses:13,favorite:true,icon:'n-i-p',description:'Glass / ITO / SnO₂ / Perovskite / Spiro-OMeTAD / Au.',meta:'v2 · recommended pipeline PSC n-i-p standard',details:[['Layers','6'],['Architecture','n-i-p'],['Solution role','Absorber precursor'],['Equipment','Spin coater · evaporator']],usage:'PSC-2026-041 · source template for S01–S04'}
  ];
  ...
  document.addEventListener('click', event => {
    ...
    if(action==='experiment-archive'){const archive={manifest:{format:'LabFlow experiment archive',version:'1.3',generated_at:new Date().toISOString(),author:currentUser().name,experiment:'EXP-2026-052',warnings:['2 columns without units','1 instrument association pending']},contents:['experiment.json','stacks/','materials/','solutions/','process/','data/','results/','charts/','reports/','files/','provenance/','nomad-mapping/']};X.download(JSON.stringify(archive,null,2),'application/json','experiment-EXP-2026-052-manifest.json');toast('Archive manifest generated','success','Static POC: the manifest represents the complete ZIP structure and exclusions.');}
  });
