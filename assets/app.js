document.addEventListener('DOMContentLoaded', () => {
  ...
  const navigation = [
    ...
    { id: 'project',   href: 'project.html#experiments', icon: 'flask',   label: 'Experiments' },
  ...
  const createTypes={
    ...
    process:{label:'Protocol',copy:'Ordered protocol and evidence',icon:'flow'},
  ...
  const globalSearchItems=[
    ...
    ['Experiments','Browse and continue laboratory experiments','project.html#experiments','workspace project experiment'],
    ...
    ['PSC n-i-p standard · v4.1','Open the approved reusable protocol','pipeline.html','protocol processing action'],
  ...
  const searchPlaceholders={dashboard:'Search experiments…',catalogs:'Search Lab Cabinet…',docs:'Search documentation…',knowledge:'Search knowledge…',report:'Search reports & exports…',editors:'Search laboratory tools…',users:'Search settings…',workspace:'Search stacks, files & results…'};
  ...
  const cabinetResources=[
    ...
    {id:'pipeline',name:'PSC n-i-p standard',type:'Protocol',category:'processes',status:'Active',tone:'success',availability:'available',location:'Shared protocol',locationKey:'all',uses:18,recent:true,favorite:true,icon:'PSC',description:'Reviewed process from substrate cleaning to Au contact.',meta:'v4.1 · 7 actions · approx. 4 h',details:[['Version','4.1'],['Actions','Clean → coat → anneal → evaporate'],['Equipment','Spin Coater 01 · Hot Plate 02'],['State','Active']],usage:'PSC-2026-041 · process run for S01 and S02'},
    ...
    {id:'stackNip',name:'PSC n-i-p standard',type:'Stack template',category:'stacks',status:'Active',tone:'success',availability:'available',location:'Shared template',locationKey:'all',uses:13,favorite:true,icon:'n-i-p',description:'Glass / ITO / SnO₂ / Perovskite / Spiro-OMeTAD / Au.',meta:'v2 · recommended protocol PSC n-i-p standard',details:[['Layers','6'],['Architecture','n-i-p'],['Solution role','Absorber precursor'],['Equipment','Spin coater · evaporator']],usage:'PSC-2026-041 · source template for S01 and S02'}
  ];
  ...
  const entityModel = {
    ...
    Workspace:{group:'Ownership root',purpose:'Private root container for one user. It owns one Lab Cabinet and optional research projects.',fields:[['id','Workspace identifier'],['owner_id','Exactly one UserAccount'],['name','Research workspace name'],['library','Reusable Lab Cabinet records'],['projects','Optional research containers'],['export_settings','NOMAD mapping preferences']],relations:[['owned by','UserAccount','1'],['contains','Lab Cabinet records','0..n'],['contains','Project','0..n']]},
  ...
  document.addEventListener('click', event => {
    ...
    if(action==='minimal-experiment-create'){const name=$('#minimalExperimentName')?.value.trim(),objective=$('#minimalExperimentObjective')?.value.trim();if(!name||!objective){toast('Name and objective required','warning','Add the two essential fields to create the experiment.');return;}toast('Experiment created','success','Next: select or create the resources you plan to use.');setTimeout(()=>location.href='experiment.html#resources',350);}
