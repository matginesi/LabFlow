...
register({id:'auto-cleanup',phase:'review',after:['review'],reads:['datasetAnalysis'],writes:['autoCleanup','patches'],run:function(exp){if(LF.DatasetCorrections&&LF.DatasetCorrections.prepareAutomaticSafeFixes)LF.DatasetCorrections.prepareAutomaticSafeFixes(exp);},description:'Detect mechanically provable cleanup and keep it pending for explicit researcher acceptance.'});
