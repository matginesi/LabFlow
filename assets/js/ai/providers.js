(function () {
  ...
  LF.AIProviders = {
    zai: {
      id:'zai', name:'Z.AI', endpoint:'https://api.z.ai/api/paas/v4/chat/completions', model:'glm-4.7-flash', keyRequired:true, modelSelect:true, remoteModelMetadata:false, staticModelCatalogue:true, modelSelectLabel:'Z.AI model', browserRelayPath:'/__labflow/zai/chat/completions', supportsJsonMode:true, supportsStreaming:true, tokenParam:'max_tokens', supportsTemperature:true, thinkingModes:{off:{thinking:{type:'disabled'}},on:{thinking:{type:'enabled'}}}, headers:{'Accept-Language':'en-US,en'}, connectionTestTimeoutMs:15000, requestDeadlineMs:180000, knownModels:['glm-4.7-flash','glm-5.3','glm-5.2','glm-5.1','glm-5','glm-4.7','glm-4.7-flashx','glm-4.6','glm-4.5','glm-4.5-air','glm-4.5-x','glm-4.5-airx','glm-4.5-flash','glm-4-32b-0414-128k'],
      note:'Z.AI uses the official General API endpoint. Detect uses LabFlow built-in metadata plus the documented Z.AI text-model catalogue snapshot. Browser requests are sent through the bundled same-origin LabFlow relay because api.z.ai does not allow this page to call Chat Completions cross-origin.'
    },
    openrouter: {
