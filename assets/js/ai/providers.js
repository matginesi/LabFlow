(function () {
  ...
  LF.AIProviders = {
    ...
    nvidia: {
      id:'nvidia', name:'NVIDIA NIM', catalogueFallbackToConfiguredModel:true, endpoint:'http://127.0.0.1:8099/nvidia/v1', upstreamEndpoint:'https://integrate.api.nvidia.com/v1', browserRelay:true, model:'nvidia/nemotron-3.5-lightning-30b-a3b', keyRequired:true, modelSelect:true, modelCatalogueRequired:true, modelSelectLabel:'NVIDIA NIM model', supportsStreaming:true, tokenParam:'max_tokens', supportsTemperature:true, connectionTestTimeoutMs:60000, connectionTestMaxTokens:128, connectionTestThinkingMode:'auto',
      note:'Hosted NVIDIA NIM through the bundled local browser relay. Run python3 tools/provider_relay.py. For a self-hosted NIM, enter its own OpenAI-compatible /v1 endpoint.'
    },
    openai: {
