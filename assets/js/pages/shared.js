(function () {
  ...
  function routeTitle(route) {
    return ({'experiment-import':'Upload & Review','experiment-understand':'Upload & Review','experiment-results':'Results','experiment-design':'Design','experiment-report':'Report','experiment-changes':'Changes','experiment-nomad':'NOMAD','knowledge-base':'Knowledge Base',settings:'Settings',logs:'Logs',documentation:'Documentation','ui-kit':'UI Kit'})[route] || 'LabFlow';
  }

  function experimentStepper() {
    const steps=[['experiment-import','1','Upload & Review'],['experiment-results','2','Results'],['experiment-design','3','Design'],['experiment-report','4','Report'],['experiment-changes','5','Changes'],['experiment-nomad','6','NOMAD']];
  ...
  function needExperiment() {
    return '<section class="page start-page">'+workflowHead('Upload experiment','Load the original laboratory ZIP to begin the Upload & Review → Results → Design → Report → Changes → NOMAD workflow.')+
