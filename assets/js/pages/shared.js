(function () {
  ...
  function routeTitle(route) {
    return ({'experiment-import':'Upload & Review','experiment-results':'Results','experiment-design':'Design','experiment-export':'Export',cabinet:'Lab Cabinet',settings:'Settings',logs:'Logs',documentation:'Documentation','ui-kit':'UI Kit'})[route] || 'LabFlow';
  }

  function experimentStepper() {
    const steps=[['experiment-import','1','Upload & Review'],['experiment-results','2','Results'],['experiment-design','3','Design'],['experiment-export','4','Export']];
