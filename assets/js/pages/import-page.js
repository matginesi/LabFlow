...
(function () {
  ...
  function receipt(exp) {
    ...
    return '<section class="panel upload-source-card"><div class="upload-source-summary"><div class="upload-source-icon" ' +
      'aria-hidden="true"><span data-icon="package-check"></span></div><div class="upload-source-copy"><span class="eyebrow">Source archive</span><strong>'+
C.escapeHtml(e.meta.sourceName)+'</strong><div class="meta">'+C.bytes(e.meta.sourceSize)+' · '+files.length+
        ' files · imported '+C.escapeHtml(importTimestamp(e.meta.createdAt))+
        '</div></div><span class="badge success upload-source-preserved">Original preserved</span></div><details ' +
      'class="upload-source-details"><summary>Source details</summary><div class="panel-body stack"><div class="import-family-grid">'+
importFamilyItem('Summary',families.summary)+importFamilyItem('JV',families.jv)+importFamilyItem('Parameters',
        families.parameters)+importFamilyItem('Tracking',families.tracking)+importFamilyItem('Other',
        families.other)+'</div><details class="compact-details"><summary>File list · '+files.length+
        '</summary><div class="file-tree upload-review-manifest">'+tree+(files.length>160?'<div class="muted">… '+
        (files.length-160)+' more files</div>':'')+'</div></details></div></details></section>';
  }
