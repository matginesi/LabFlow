(function () {
  ...
  function hydrateLazyDetail(host){
    ...
    const entry=entries.find(function(x){return String(x.id||x.seq)===String(id);});
    if(entry)html=entryDetail(entry);
