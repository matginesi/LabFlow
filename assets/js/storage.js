(function(){
  ...
  function getKnowledgeBase(){return clone(read('labflow.design.knowledge-base',{version:1,records:[],updatedAt:null}));}
  function saveKnowledgeBase(v){const next=clone(v&&typeof v==='object'?v:{version:1,records:[]});next.version=1;next.records=Array.isArray(next.records)?next.records:[];next.updatedAt=new Date().toISOString();write('labflow.design.knowledge-base',next);return clone(next);}
